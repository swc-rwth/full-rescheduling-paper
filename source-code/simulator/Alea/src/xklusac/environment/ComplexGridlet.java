...
public class ComplexGridlet extends Gridlet implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException{
        ComplexGridlet gl = new ComplexGridlet(getGridletID(), user, job_limit, getGridletLength(), estimatedLength, 10, 10, osRequired, archRequired, arrival_time, due_date, priority, numPE, 0.0, queue, properties, percentage, ram, numNodes, ppn);
